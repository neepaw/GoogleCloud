...
parameters = [
            ...
            {'C': [1,10,100,1000], 'kernel': ['poly'], 'degree':[2,3,4,5], 'gamma': [0.5,0.1,0.01,0.001,0.0001], 'coef0':[0.5,0.1,0.01,0.001,0.0001] },
            {'C': [1,10,100,1000], 'kernel': ['sigmoid'],'coef0':[0.5,0.1,0.01,0.001,0.0001],'gamma': [0.5,0.1,0.01,0.001,0.0001]}
            ]
